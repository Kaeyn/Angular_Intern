...
export class PHrQuestionBankComponent implements OnChanges, OnInit{
  ...
  requestApproveItem(question : Question){
      ...
      if(foundQuestion){
        ...
        this.questionService.updateQuestion(foundQuestion, 1);
        return 1;
      }else{
        return 0
      }
  ...
  approveItem(question : Question){
    ...
    if(foundQuestion){
      this.questionService.updateQuestion(foundQuestion, 2);
      return 1;
    }else{
      return 0
    }
  ...
  stopDisplayItem(question : Question){
    ...
    const foundQuestion = this.filteredQuestionList.find(dataquest => dataquest.id == question.id);
    if(foundQuestion){
      this.questionService.updateQuestion(foundQuestion, 3);
      return 1;
    }else{
      return 0
    }
  ...
  returnItem(question : Question){
    ...
    const foundQuestion = this.filteredQuestionList.find(dataquest => dataquest.id == question.id);
    if(foundQuestion){
      this.questionService.updateQuestion(foundQuestion, 4);
      return 1;
    }else{
      return 0
    }
